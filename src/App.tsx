  ...
  return (
    <>
      <main className="h-screen w-screen">
        <div className="flex flex-row justify-center items-center w-full mt-5">
          ...
          <div className="flex flex-col items-center justify-center">
            <h1 className="font-bebas text-4xl md:text-6xl tracking-wider">
              <span className="text-gray-900">DAVA</span>
              <span className="text-red-600">DEKHO</span>
            </h1>
        ...
        <h1 className="font-bebas text-4xl md:text-6xl tracking-wider flex flex-row items-center justify-center w-full mt-6 font-bold">
          <span className="text-gray-900">FLAT 20%</span>
          <span className="text-red-600">OFF</span>
        </h1>
        <h2 className="text-2xl md:text-3xl tracking-wider flex flex-row items-center justify-center w-full mt-4 font-bold">
          <span className="text-gray-900">On all medicines</span>
        </h2>
